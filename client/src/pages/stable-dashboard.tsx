            ...
            <div className="flex items-center justify-between mb-4">
              ...
              <div className="flex space-x-2">
                <button 
                  ...
                  className="text-green-600 text-sm font-medium hover:text-green-700 flex items-center space-x-1"
                >
                ...
                <button 
                  ...
                  className="text-purple-600 text-sm font-medium hover:text-purple-700 flex items-center space-x-1"
                >
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
